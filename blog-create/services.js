...
.factory('Blog', function($resource){
  var BlogRes = $resource('http://CVDB-dev.elasticbeanstalk.com/posts/:postId', {postId: '@id'})
  var UserRes = $resource('http://CVDB-dev.elasticbeanstalk.com/users/:userId', {userId: '@id'})
  var FavRes = $resource('http://CVDB-dev.elasticbeanstalk.com/favourites/:favId', {favId: '@id'})
  var colors = [
    // "#8E39E9","#85F02D", "#2D85F0", "#39E9E6", "#E97139",
     "rgb(63, 63, 191)","rgb(191, 63, 191)",
       "rgb(191, 191, 63)", "rgb(75, 225, 75)",
  ...
  return {
    createUser: function(newUser){
      console.log("!")
      var user = new UserRes({email: newUser.email, password: newUser.password});
    ...
    createFav: function(newFav){
      var fav = new FavRes({
        url: newFav.url,
        citation: newFav.citation,
        password: newFav.password
      });
      fav.$save(function(data){
        console.log(data)
      }, function(err){
        console.log(err)
      })
    ...
    getPost: function(postId) {
      BlogRes.get({postId: postId}, function(data){
        return data
      })
    },
    createPost: function(newPost){
      var post = new BlogRes({
        title: newPost.title,
        quote: newPost.quote,
        body: newPost.body,
        main_img: newPost.main_img,
...
//     var params = {
//         'TableName': 'Posts',
//         'KeyConditionExpression': 'PostID' {'N':1},
//     };
//     var db = dynamoDb.query(params, function (err, data) {
...
//     })
//   },
//   putPost: function(newPost){
//     var params = {
//         TableName: 'Posts',
//         Item: { // a map of attribute name to AttributeValue
//
//             'PostID':{'N': newPost.id},
//             "MainImg": {'S': newPost.main_img},
//             "Title":{'S':  newPost.title},
//             "Quote": {'S': newPost.quote}
//         },
